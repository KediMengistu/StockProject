...
//         className="h-full w-full p-2 flex items-center justify-center overflow-y-hidden scrollbar-hide"
//       >
//         <Card className="p-4 grid grid-rows-[auto_auto] gap-2 text-[10px] md:text-[12px] max-w-[475px] min-w-[250px] italic overflow-y-auto scrollbar-hide">
//           <div>
...
//                   up-to-date stock data, the seperate CRON Job Docker container
//                   is tasked with retreiving stock data for each symbol at 9am,
//                   12pm, and 3pm Monday through Friday from an external stock
//                   API.
//                 </span>
//               </li>
//               <li className="mt-2 font-bold not-italic text-black dark:text-white">
//                 <span className="font-normal italic text-muted-foreground">
//                   It then stores these up-to-date stock data points in the
//                   MariaDB database in the MariaDB Docker container, where the
//                   database ensures a max of 9 data points are maintained for
//                   each symbol.
//                 </span>
//               </li>
//               <li className="mt-2 font-bold not-italic text-black dark:text-white">
...
//                   they must provide their google mail account.
//                 </span>
//               </li>
//               <li className="mt-2 font-bold not-italic text-black dark:text-white">
//                 <span className="font-normal italic text-muted-foreground">
...
//                   request to the containerized Django app that exists in the AWS
